...
st.sidebar.markdown("You GET <ol><li>You can search for a particular player.</li> "
                    "<li>You can see the current season stats of the player.</li> "
                    "<li>A chart of the players shooting Area, different area shots attempted and made.</li>"
                    "<li>A chart of the player average PTS, AST, and REB over years.</li>"
