...
def get_current_season(player_id):
    ...
    player_season_stats = df_player_info[1]
...
def get_career_stats(player_id):
    ...
    regular_season_tot = regular_season.append(df_p[1])
    ...
    allstar_stats_tot = allstar_stats.append(df_p[5])
